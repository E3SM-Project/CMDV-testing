...
class TestSession(unittest.TestCase):
    ...
    def test_is_class(self):
        self.assertIsInstance(
            self.session_full, Config.Session, msg='Not of class Session')
        self.assertIsInstance(self.session_empty,
                              Config.Session, msg='Not of class Session')
    ...
    def test_create_session(self):
        ...
        self.assertIsInstance(session, Config.Session,
                              msg='Not of class Session')
