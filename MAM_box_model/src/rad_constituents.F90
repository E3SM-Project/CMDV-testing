...
!        spechygro(l,m)      = 0.068_r8
      ...
      real(r8) :: dgnum_amode_rc(n_modes)   = (/ 0.1100e-6, 0.0260e-6, 2.000e-6, 0.050e-6 /)
      real(r8) :: dgnumlo_amode_rc(n_modes) = (/ 0.0535e-6, 0.0087e-6, 1.000e-6, 0.010e-6 /)
      real(r8) :: dgnumhi_amode_rc(n_modes) = (/ 0.4400e-6, 0.0520e-6, 4.000e-6, 0.100e-6 /)
      real(r8) :: sigmag_amode_rc(n_modes)  = (/ 1.800, 1.600, 1.800, 1.600 /)
      ...
      real(r8), parameter :: rhcrystal_amode_rc(n_modes)   = 0.350
      real(r8), parameter :: rhdeliques_amode_rc(n_modes)  = 0.800
...
!     end do
      ...
      if (itmpm <= 0 .or. itmps <= 0) then
         write(*,'(3a)') 'rad_cnst_get_info_v1 warning - specname = |', specname, '|'
      end if
...
!     complex(r8), dimension(nlwbands), optional :: refindex_aer_lw
      ...
      complex(r8), target :: tmp_refindex_aer_lw(nswbands)
